...
public class Celdas {
   ...
   * @param valor es el que indica la cantidad de lamparas que tiene que haber a su alrededor.
   ...
   * @return valorCelda con el numero de lamparas que deben encontrarse alrededor de la celda.
   */
