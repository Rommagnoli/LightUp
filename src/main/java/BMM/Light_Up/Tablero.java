...
public class Tablero {
  ...
  /**
   * Funcion que retorna todas las posiciones de celdas negras con valor.src/main/java/BMM/Light_Up/Tablero.java
   ...
   * @throws InvalidConfigurationException Cuando una configuracion es invalida.
   */
